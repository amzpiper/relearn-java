...
public class ForkJoinDemo {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Expected sum: %d in %d ms." , expectedSum,endTime-startTime));
        ...
        //上述代码的执行过程，一个大的计算任务0~2000首先分裂为两个小任务0~1000和1000~2000，
        //这两个小任务仍然太大，继续分裂为更小的0~500，500~1000，1000~1500，1500~2000，
        //最后，计算结果被依次合并，得到最终结果。
        //因此，核心代码SumTask继承自RecursiveTask，在compute()方法中，
        //关键是如何“分裂”出子任务并且提交子任务：
